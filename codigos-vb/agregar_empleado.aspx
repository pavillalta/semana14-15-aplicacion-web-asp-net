<%@ Page Title="" Language="VB" MasterPageFile="~/index.master" AutoEventWireup="false" CodeFile="agregar_empleado.aspx.vb" Inherits="Agregar_agregar_empleado" %>
...
<br />
    <table align="center" class="style51" 
        ...
        <tr>
            <td colspan="2">
        <span class="style14">REGISTRO DE NUEVOS EMPLEADOS</span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                    <asp:Button ID="btnagregar" runat="server" Font-Bold="True" 
                        style="text-align: center" Text="Agregar Empleado" Width="204px" />
                    </td>
        </tr>
        <tr>
            <td colspan="2">
