...
<p class="style10" style="text-align: center">
    INGRESO DE USUARIO CON VALIDACION DESDE BASE DE DATOS</p>
<p class="style7">
    Este es un ejemplo de como podemos validar un usuario desde la base de datos</p>
<p class="style7">
    Es un método más seguro que el anterior, pero la contraseña aún no está 
    encriptada</p>
<p class="style7">
    &nbsp;</p>
            ...
            <tr>
                <td colspan="2" style="text-align: center">
                    ...
                    <asp:Button ID="btnvalidar" runat="server" style="font-weight: 700" 
                        Text="Comprovar Usuario" Width="208px" />
                </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: center">
